...
namespace Business.Models
{
                                           ...
                                           // miras alsın hem de servislerde tip olarak kullanılabilsin.
    {
        ...
        // ihtiyaç halinde view'larda gösterim için entity verilerini özelleştirip (formatlama, ilişkili entity referansı üzerinden özellik kullanma, vb.) kullanacağımız yeni özellikler oluşturulabilir.
